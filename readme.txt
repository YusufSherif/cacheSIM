...
Note: This cahce is a directly associative cache and it does not actually store any data, rather it simulates storing the data in the cache by storing the tag in each line object in the tag field. This program is used to simulate the cache behaviour and get expected hit ratio from the memGen functions.
